        ...
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col px-4">
          <div className="flex gap-4 flex-col">
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
              Il semble qu'il y ait eu un problème lors de la réinitialisation
              de votre mot de passe. Le token de réinitialisation est peut-être
              invalide ou expiré. Veuillez réessayer en demandant un nouveau
              lien de réinitialisation ou contacter le support si le problème
              persiste.
            </p>
          </div>
