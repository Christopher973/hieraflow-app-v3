        ...
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col px-4">
          <div className="flex gap-4 flex-col">
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
              Votre demande de création de compte a été enregistrée. Veuillez
              vérifier votre boîte de réception pour accéder au lien de
              vérification. Si vous ne voyez pas l'email, pensez à vérifier
              votre dossier de spam ou contacter le support.
            </p>
          </div>
